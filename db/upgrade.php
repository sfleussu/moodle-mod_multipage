...
function xmldb_multipage_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the multipage
     * iself has been upgraded.
     *
     * For each upgrade block, the file multipage/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to multipage.
        ...
        // Define field intro to be added to multipage.
        $table = new xmldb_table('multipage');
        ...
        // Define field introformat to be added to multipage.
        $table = new xmldb_table('multipage');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'multipage');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to multipage.
        $table = new xmldb_table('multipage');
        ...
        // Define field timemodified to be added to multipage.
        $table = new xmldb_table('multipage');
        ...
        // Define index course (not unique) to be added to multipage.
        $table = new xmldb_table('multipage');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'multipage');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'multipage');
    }
