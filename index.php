...
$event = \mod_multipage\event\course_module_instance_list_viewed::create($params);
$event->add_record_snapshot('course', $course);
$event->trigger();

$strname = get_string('modulenameplural', 'mod_multipage');
$PAGE->set_url('/mod/multipage/index.php', array('id' => $id));
...
$currentsection = '';
foreach ($modinfo->instances['multipage'] as $cm) {
    $row = array();
    if ($usesections) {
